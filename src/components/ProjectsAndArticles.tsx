...
const portfolioItems = [
  {
    ...
    description:
      "Como cada clique, detalhe visual e interação podem gerar marcadores positivos ou afastar de vez o usuário.",
    type: "Artigo",
    date: "2025-09-25",
  ...
  },
  {
    ...
    description:
      "O que a Lei de Hick e o Paradoxo da Escolha nos ensinam sobre decisões rápidas e interfaces mais eficientes.",
    type: "Artigo",
    date: "2025-08-21",
    category: "UX Collective BR",
